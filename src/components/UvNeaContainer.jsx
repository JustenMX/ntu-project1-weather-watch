    ...
    <>
      <div className="flex flex-col items-center mx-auto bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
        <div className="w-full px-4 py-2">
          ...
          <div className="w-full px-4 py-2 text-center text-gray-700 dark:text-white">
            <p className="mb-4">
            ...
            <p className="mb-4">
              In Singapore, the UVI is measured at the Changi Meteorological
              Station and reported hourly between 7am and 7pm. The reported UVI
              represents its average value for the past 15 minutes. In the
              presence of rain and/or under cloudy conditions, the UVI value is
              reduced. Therefore, the UVI value may vary in other parts of the
              island.
            </p>
            ...
            <p className="mb-4">
              Some ultraviolet (UV) exposure is important for health functions
              such as Vitamin D production in the body and treating diseases
              like jaundice in babies or psoriasis and rickets in adults.
            </p>

            <p className="mb-4">
              However, excessive exposure to solar UV radiation can result in
              harmful effects to the skin and eyes. If you must be out in the
              sun, especially between 11am and 3pm when the UV index levels are
              highest, the following simple protective measures can help to
